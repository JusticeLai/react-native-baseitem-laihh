    ...
    renderType4() {
        ...
        return (
            <TouchableOpacity onPress={onPress} style={{backgroundColor: 'white'}}>
                ...
                {this.renderLine(15, paddingVertical - 8, lineHeight)}
            </TouchableOpacity>
        )
    }
        ...
        return (
            <TouchableOpacity style={{flexDirection: 'column', flex: 1, backgroundColor: 'white',}}
                ...
                >
                    ...
                    <View style={{flex: 1, justifyContent: 'center'}}>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'flex-start'}}>
                            <Text style={{color: text1Color}} numberOfLines={1}>{text1}</Text>
                        </View>
                        <View style={{flex: 1, justifyContent: 'center', alignItems: 'flex-start'}}>
                            <Text style={{color: text2Color}} numberOfLines={1}>{text2}</Text>
                        </View>
                ...
                <View style={{flex: 1, flexDirection: 'row'}}>
                    ...
                    <View style={{flex: 1, marginLeft: 5, flexDirection: 'row'}}>
                        ...
                        <View style={{
                            ...
                            <Text style={{fontSize: text6fontSize, color: text6Color, marginTop: 15}}
                                  numberOfLines={1}>{text6}</Text>
                        </View>
                    </View>
                </View>
                {this.renderLine(15, paddingVertical, lineHeight)}
                    ...
                    <View style={{flex: 1, marginLeft: 5, flexDirection: 'row'}}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity onPress={onBtnPress} style={{
                                ...
                                <Text style={{color: CommonStyle.MAIN_COLOR_BLUE, fontSize: 12}}>{'设置日用量'}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
        ...
        return (
            <TouchableOpacity
                ...
                <View style={{
                    ...
                    <Text style={{color: text1Color, fontSize: text1fontSize}}>{text1}</Text>
                    <Text style={{color: text2Color, fontSize: text2fontSize}}>{text2}</Text>
                    <Image style={{width: 15, height: 15, marginRight: 5}} source={image}/>
                </View>
                {this.renderLine(15, paddingVertical, lineHeight)}
            </TouchableOpacity>
        )
